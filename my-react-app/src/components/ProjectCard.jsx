...
<div class="max-w-sm bg-[#161719] rounded-lg shadow  ">
    ...
    <div class="p-5 bg-[#d2b48c] bg-opacity-40 rounded ">
        ...
        <p class="mb-3 font-normal text-white">The kitchen has become the new focal point & gathering place in the home, it is where family and friends come to meet, entertain and simply spend time together.</p>
...
<div class="max-w-sm bg-[#161719] rounded-lg shadow  ">
    ...
    <div class="p-5 bg-[#d2b48c] bg-opacity-40 rounded ">
        ...
        <p class="mb-3 font-normal text-white">The bathroom is one of the most frequently visited rooms in the home and as such has become a space where homeowners want to put their personal touch with regards to design.</p>
        <a href="#" class="flex items-center justify-center rounded-md border border-transparent bg-[#D2B48C] bg-opacity-60 px-4 py-3 font-medium text-black shadow-sm hover:bg-opacity-70 sm:px-8">
            See More
            <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
        </a>
...
<div class="max-w-sm bg-[#161719] rounded-lg shadow  ">
    ...
    <div class="p-5 bg-[#d2b48c] bg-opacity-40 rounded ">
        ...
        <p class="mb-3 font-normal text-white">While kitchens and bathrooms are the most common & traditional areas, we see clients utilizing stone in a variety of other locations in the home.</p>
        <a href="#" class="flex items-center justify-center rounded-md border border-transparent bg-[#D2B48C] bg-opacity-60 px-4 py-3 font-medium text-black shadow-sm hover:bg-opacity-70 sm:px-8">
            See More
            <svg aria-hidden="true" class="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
        </a>
