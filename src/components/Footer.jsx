const navigation = {
    ...
    social: [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/PrecisionStoneworks/',
            icon: (props) => (
        ...
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/precision_stoneworks/',
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        <footer className="bg-[#161719] mb-0 pb-0 border-t">
            <div className="mx-auto max-w-7xl overflow-hidden px-6 sm:py-24 lg:px-8">
                ...
                <p className=" text-center text-xs leading-5 text-gray-500">
                    Website Designed And Developed By: <a href="https://www.mackgrissom.io" className="text-white">Mack Grissom, <br/></a> <a href="https://www.fullcircledesign.io" className="text-[#d2b48c]  mb-0 pb-0">Full Circle Web Design</a>
                </p>
            </div>
        </footer>
    )
